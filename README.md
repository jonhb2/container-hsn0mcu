...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hsn0mcu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hsn0mcu.containers.anotherwebservice.com/
...
```
git clone git@github.com:jonhb2/container-hsn0mcu.git
cd container-hsn0mcu
```
...
```
docker attach container-hsn0mcu
```
